...
<div class="register_page_wrapper container">
    ...
    <form method="post">
        ...
        <button disabled type="button" class="btn btn-secondary btn-register">Register with Facebook</button>
        <button disabled type="button" class="btn btn-secondary btn-register">Register with Google</button>
